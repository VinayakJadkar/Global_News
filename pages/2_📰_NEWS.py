...
def fetch_news_data_cached(category, country):
    url = f"https://newsdata.io/api/1/news?apikey={api_key}&language=en&country={country}&category={category}"
...
if fetch_result:
    ...
    news_data = fetch_news_data_cached(selected_category, selected_country)
