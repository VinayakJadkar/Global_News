...
selected_category = st.sidebar.selectbox("Category", ["business", "entertainment","environment","food", "general", "health", "politics", "science", "sports", "technology", "top", "tourism", "world"])
...
def fetch_news_data_cached(category, country, language):
    url = f"https://newsdata.io/api/1/news?apikey={api_key}&language={language}&country={country}&category={category}"  # Use selected language
...
if fetch_result:
    ...
    news_data = fetch_news_data_cached(selected_category, selected_country, selected_language_code)  # Pass selected language code
